...
- [[Frida-Server-Setup]] in [[Tools]] walks through getting `frida-server` running on an x86_64 emulator with root — required before any script here can attach to anything.
