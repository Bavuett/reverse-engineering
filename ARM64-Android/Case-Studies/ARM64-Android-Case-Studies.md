...
1. Create `ARM64-Android/Case-Studies/<project-name>/` and use the [[New-Case-Study]]
   template for its overview note.
2. Import only the files you actually need into
   `ARM64-Android/Case-Studies/<project-name>/source/`, keeping their original file/module
   layout.
3. Add analysis notes under `ARM64-Android/Case-Studies/<project-name>/notes/` using the
   [[New-Case-Study-Note]] template.
4. Add a `folder_templates` entry mapping `ARM64-Android/Case-Studies/<project-name>/notes`
