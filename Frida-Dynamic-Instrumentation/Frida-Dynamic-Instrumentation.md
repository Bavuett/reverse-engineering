...
| [[Frida-Dynamic-Instrumentation-Case-Studies\|Case Studies]] | full real-project investigations |
| [[Frida-Dynamic-Instrumentation-Cheatsheets\|Cheatsheets]] | standalone quick-reference pages |
| [[Frida-Dynamic-Instrumentation-Tools\|Tools]] | notes on the tools you actually use |
| [[Frida-Dynamic-Instrumentation-Reading-Notes\|Reading Notes]] | books, courses, papers, RFCs |
| [[Frida-Dynamic-Instrumentation-Projects\|Projects]] | personal coding projects |
...
8. For a full, real-world investigation of one app at a time, see [[Frida-Dynamic-Instrumentation-Case-Studies|Case Studies]] — in particular the ongoing ClasseViva one, which reuses the static findings from [[ARM64-Android-Case-Studies|ARM64-Android's Case Studies]].
