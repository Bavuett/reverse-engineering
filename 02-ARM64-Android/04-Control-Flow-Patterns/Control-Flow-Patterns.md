...
The real cascading-compare `switch`-over-enum pattern (`AbsenceLocalizations.absenceAbbreviationName` — see the full excerpt in [[Enum-Switch-Via-Pointer-Comparison]]):
